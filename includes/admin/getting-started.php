...
<div style="float:right"><img src="https://emd-plugins.s3.amazonaws.com/sim_logo.png"></div>
...
</ol></div></div><div style="margin-top:15px"><a href="#rtop" class="top">Go to top</a></div><hr style="margin-top:40px"><div class="getting-started emd-section changelog getting-started getting-started-9" style="margin:0;background-color:white;padding:10px"><div style="height:40px" id="gs-sec-9"></div><h2>How to create your first issue</h2><div id="gallery" class="wp-clearfix"><div class="sec-img gallery-item"><a class="thickbox tooltip" rel="gallery-9" href="https://emdsnapshots.s3.amazonaws.com/simcom-issue_edit.png"><img src="https://emdsnapshots.s3.amazonaws.com/simcom-issue_edit.png"></a></div></div><div class="sec-desc"><p>Issues can be any type of defects, feature requests, improvements etc. Issues can be shared by many projects.</p>
<ol>
...
</ol></div></div><div style="margin-top:15px"><a href="#rtop" class="top">Go to top</a></div><hr style="margin-top:40px"><div class="getting-started emd-section changelog getting-started getting-started-17" style="margin:0;background-color:white;padding:10px"><div style="height:40px" id="gs-sec-17"></div><h2>How to customize it to better match your needs</h2><div id="gallery" class="wp-clearfix"><div class="sec-img gallery-item"><a class="thickbox tooltip" rel="gallery-17" href="https://emdsnapshots.s3.amazonaws.com/simcom-customization.png"><img src="https://emdsnapshots.s3.amazonaws.com/simcom-customization.png"></a></div></div><div class="sec-desc"><p>Software Issue Manager can be customized from plugin setting without modifying code or theme templates(most cases)</p>
<ul>
...
</ul></div></div><div style="margin-top:15px"><a href="#rtop" class="top">Go to top</a></div><hr style="margin-top:40px"><div class="getting-started emd-section changelog getting-started getting-started-18" style="margin:0;background-color:white;padding:10px"><div style="height:40px" id="gs-sec-18"></div><h2>How to limit access to issue entry and search forms by logged-in users only</h2><div id="gallery" class="wp-clearfix"><div class="sec-img gallery-item"><a class="thickbox tooltip" rel="gallery-18" href="https://emdsnapshots.s3.amazonaws.com/simcom-loginregform.png"><img src="https://emdsnapshots.s3.amazonaws.com/simcom-loginregform.png"></a></div></div><div class="sec-desc"><ol>
...
</div></div><div style="margin-top:15px"><a href="#rtop" class="top">Go to top</a></div><hr style="margin-top:40px"><div class="getting-started emd-section changelog getting-started getting-started-19" style="margin:0;background-color:white;padding:10px"><div style="height:40px" id="gs-sec-19"></div><h2>How to resolve theme related issues</h2><div id="gallery" class="wp-clearfix"></div><div class="sec-desc"><p>If your theme is not coded based on WordPress theme coding standards and does have an unorthodox markup, you might see some unussual things on your site such as sidebars not getting displayed where they are supposed to or random text getting displayed on headers etc. The good news is you may fix all of theme related conflicts following the steps in the documentation.</p>
...
<?php echo '</div>';
	...
	echo '>';
?>
<p class="about-description">Software Issue Manager Community V4.1.0 offers many new features, bug fixes and improvements.</p>
