=== WordPress Bug Issue Tracking and Project Management Plugin - Software Issue Manager ===
...
Tags: bug, issue tracking, defect, bug tracking, issue management
...
Software Issue Manager enables development teams to document, analyze, track and prioritize projects and issues.

== Description ==
Software Issue Manager(SIM) is a project based bug, issue, task and product feature request tracking system with extensive built-in and custom reporting capabilities. [Premium editions](https://emdplugins.com/software-issue-manager-wordpress-plugin) are available.
...
We, Emarket Design, believe that one of the most important factors affecting production of quality products is having a strong requirement management and analysis process. Most projects fail because organizations do not spend enough time on this stage of the project life cycle. By developing a family of products primarily designed for software issue management, we wanted to meet the needs of like-minded organizations as well as ours and do our share of promoting importance of requirement management and analysis process.
...
The SIM community edition uses built-in roles:
...
= Works with AddOns =
* If you need issues to be created through email (POP3/IMAP supported), you can purchase [Incoming Email Addon](https://emdplugins.com/plugin-features/software-issue-manager-incoming-email-addon).
* Connect issues with EDD products [Easy Digital Downloads Software Issue Manager Addon](https://emdplugins.com/plugin-features/software-issue-manager-easy-digital-downloads-addon)
* Connect issues with Woo products [WooCommerce Software Issue Manager Addon](https://emdplugins.com/plugin-features/software-issue-manager-woocommerce-addon)
* Bulk import/export your issues and projects from/to CSV files [CSV Import Export Addon](https://emdplugins.com/plugin-features/software-issue-manager-importexport-addon)
* Find issues faster with extensive search and filtering [Smart Search and Columns Addon](https://emdplugins.com/plugin-features/software-issue-manager-smart-search-and-columns-addon)

= Community Edition Features =
* Made and supported in Miami, USA with love
* Full page customization without modifying theme files
* Enable/disable any field from plugin settings
* EMD Widget area to display widgets on issue and project pages
* Designed to minimize theme related markup issues
* Create public and private(logged-in users only) projects and issues
...
* Custom field support for projects and issues.
...
[Pro Edition](https://emdplugins.com/plugin-pricing/software-issue-manager-wordpress-plugin-pricing/)
...
[Enterprise Edition](https://emdplugins.com/plugins/software-issue-manager-wordpress-plugin/)

For detailed feature by feature comparison of all editions, go to one of the premium plugin pages and click "Compare" in the menu. You can also open a [support ticket](https://emdplugins.com/support/).
...
13. Get insight on your products linking them to issues using [SIM WooCommerce](https://emdplugins.com/plugin-features/software-issue-manager-woocommerce-addon/?pk_campaign=simcom-screenshots&pk_kwd=simcom-woo) and [SIM Easy Digital Downloads](https://emdplugins.com/plugin-features/software-issue-manager-easy-digital-downloads-addon/?pk_campaign=simcom-screenshots-buybtn&pk_kwd=simcom-edd)
14. [CSV Import Export Addon](https://emdplugins.com/plugin-features/software-issue-manager-importexport-addon) - Bulk import/export your issues and projects from/to CSV files
15. [Incoming Email Addon](https://emdplugins.com/plugin-features/software-issue-manager-incoming-email-addon)
...
* FIXED WP Sessions security vulnerability
= 2.2.0 =
* WordPress 4.4 compatibility, issue results page fixes and more
= 2.0.1 =
* Fixed the issue related to some taxonomies not displaying in the admin backend
= 2.0.0 =
