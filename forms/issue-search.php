...
<!-- text input-->
<?php if ($form_variables['emd_iss_email']['show'] == 1) { ?>
<div class="col-md-<?php echo $form_variables['emd_iss_email']['size']; ?> woptdiv">
<div class="form-group">
<label id="label_emd_iss_email" class="control-label" for="emd_iss_email">
<?php _e('Email', 'software-issue-manager'); ?>
<span style="display: inline-flex;right: 0px; position: relative; top:-6px;">
<?php if (in_array('emd_iss_email', $req_hide_vars['req'])) { ?>
<a href="#" data-html="true" data-toggle="tooltip" title="<?php _e('Email field is required', 'software-issue-manager'); ?>" id="info_emd_iss_email" class="helptip">
<span class="field-icons icons-required"></span>
</a>
<?php
	} ?>
